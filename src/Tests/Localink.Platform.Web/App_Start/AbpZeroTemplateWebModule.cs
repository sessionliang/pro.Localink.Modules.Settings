...
using Localink.Platform.Web.App.Startup;//SPA!
using Localink.Platform.Web.Areas.Mpa.Startup;//MPA!
using Localink.Platform.Web.Bundling;
using Localink.Platform.Web.Navigation;
using Localink.Platform.Web.Routing;
using Localink.Platform.WebApi;
using Localink.Modules.Main.Web;
using Localink.Modules.Main.EntityFramework;
using Localink.Modules.Settings.Web;
using Localink.Modules.Settings.EntityFramework;

namespace Localink.Platform.Web
{
    /// <summary>
    ...
    [DependsOn(
        ...
        typeof(MainWebModule),
        typeof(MainEntityFrameworkModule),
        typeof(SettingsWebModule),
        typeof(SettingsEntityFrameworkModule)
