...
using Localink.Platform.Chat;
using Localink.Platform.Chat.Dto;
using Localink.Platform.Friendships;
using Localink.Platform.Friendships.Dto;

namespace Localink.Platform.Web.Chat.SignalR
{
